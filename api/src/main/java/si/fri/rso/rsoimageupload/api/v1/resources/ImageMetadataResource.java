...
import si.fri.rso.rsoimageupload.lib.Base64FileConverter;
import si.fri.rso.rsoimageupload.lib.ImageMetadata;
import si.fri.rso.rsoimageupload.services.awss3.AWSS3Client;
import si.fri.rso.rsoimageupload.services.beans.ImageMetadataBean;
...
public class ImageMetadataResource {
    ...
    public Response createImageMetadata(ImageMetadata imageMetadata) throws IOException {
        ...
        if ((imageMetadata.getTitle() == null || imageMetadata.getDescription() == null || imageMetadata.getImage() == null)) {
